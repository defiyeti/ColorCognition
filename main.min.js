var _config = {
    ...
    timeLineLink: "http://112.124.100.147/color/",
    tTitle: "看你有多色？",
    tContent: "找出所有色塊中顏色不同的一塊。分享到朋友圈，找到身邊的色魔"
};
!function() {
    var a = $("#box"), b = {
        lv: $("#room .lv em"),
        ...
        pause: function() {
            this._pause=!0, b.d_share.hide(), b.d_content.hide(), b.d_pause.show(), b.dialog.show()
        },
        tick: function() {
        ...
        gameOver: function() {
            ...
            this.lastLv = this.lv, this.lastGameTxt = d.txt, this.lastGamePercent = d.percent, b.d_share.hide().find("h3").text(this.lastGameTxt), b.d_content.hide(), b.d_gameover.show().find("h3").text(this.lastGameTxt), a.find("span").fadeOut(1e3, function() {
                b.dialog.fadeIn()
            }), this._pause=!0, this.reset(), fb_share()
        },
        reset: function() {
        ...
        loading: function() {
            ...
            document.addEventListener("WeixinJSBridgeReady", function() {
                WeixinJSBridge && (WeixinJSBridge.on("menu:share:appmessage", function() {
                    var a = Game.lastLv > 0 ? "我闖過" + (Game.lastLv + 1) + "關，擊敗" + Game.lastGamePercent + "%的人！我是【" + Game.lastGameTxt + "】！不服來戰！": shareData.tTitle;
    ...
    var a = $("#box"), b = "span", c = $("#help p"), d = $("#help_color"), e = {
        lvT: ["瞎子", "色盲", "色郎", "色狼", "色鬼", "色魔", "超級色魔", "變態色魔", "孤獨求色"],
        render: function(e, f) {
